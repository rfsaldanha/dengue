...
This notebook aims to create a database with aggregated counts of positive dengue cases for specific spatial and time units.

The aggregation will be on municipalities and time will be date and epidemiological week.

Input: improved suspected cases parquet file.

Output: parquet files with aggregated counts of confirmed dengue cases by municipality of residence, date and epidemiological week.
